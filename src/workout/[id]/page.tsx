    ...
    return (
      <main className="min-h-screen bg-[#090a0c] px-5 py-16 text-white">
        <div className="mx-auto max-w-[1100px]">
          ...
          <Link
            href="/"
            className="mt-6 inline-block rounded-lg bg-[#ccff00] px-5 py-3 text-sm font-bold text-black transition-transform duration-200 hover:-translate-y-1"
          >
            Back to Library
          </Link>
        </div>
      ...
      <section className="px-5 py-8 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-[1100px]">
          <div className="mb-5">
            <Link
              href="/"
              className="text-sm font-semibold text-[#7d8ba3] transition-colors hover:text-white"
            >
              ← Back to Library
            </Link>
          </div>
          ...
          <div className="overflow-hidden rounded-[18px] border border-[#292d35] bg-[#101216]">
            <div className="grid grid-cols-1 gap-0 lg:grid-cols-[1fr_1fr]">
              ...
              <div className="p-6 sm:p-8">
                <h1 className="text-[28px] font-black uppercase leading-[1.05] tracking-tight sm:text-[34px]">
                  {workout.name}
                </h1>
                ...
                <div className="mt-4 flex flex-wrap gap-2">
                  {workout.muscleGroups.map((muscle) => (
                    <span
                      key={muscle}
                      className="rounded-full bg-[#ccff00] px-3 py-1.5 text-[10px] font-bold uppercase leading-none text-black"
                    >
                      {muscle}
                    </span>
                  ))}
                ...
                <div className="mt-5 overflow-hidden rounded-[12px] border border-[#272b32] bg-[#15171c]">
                  <div className="grid grid-cols-2">
                    ...
                    <div className="border-b border-l border-[#272b32] px-4 py-3">
                      <p className="text-[9px] font-bold uppercase text-[#697386]">
                        Difficulty
                      </p>
                      <p className="mt-1 text-[12px] text-[#d5d9e0]">
